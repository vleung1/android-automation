...
public class GmailLoginDemoExcel {
	...
	public void doLogin(String username, String password, String browser) { // these values should reflect the columns available in excel sheet data
		...
		//the below locator strategy was throwing element not focusable error on Edge browser, so use Actions instead
		//driver.findElement(By.xpath("//*[@id='identifierId']")).sendKeys(username);
		actions.moveToElement(driver.findElement(By.xpath("//*[@id='identifierId']"))).click().sendKeys(username).build().perform();
	...
	public Object[][] getData() throws IOException {
		...
		FileInputStream fis = new FileInputStream("C:\\Users\\vince\\Documents\\gmaillogintestdata.xlsx"); 
